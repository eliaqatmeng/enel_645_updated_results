...
# Output file names
output_file = 'apr24/densenet_untrained/densenet_untrained_output.txt'
roc_curve_png = 'apr24/densenet_untrained/ROC_curve_densenet_untrained.png'
roc_curve_txt = 'apr24/densenet_untrained/ROC_data_densenet_untrained.csv'
confusion_matrix_png= 'apr24/densenet_untrained/confusion_matrix_densenet_untrained.png'
...
def compute_grad_cam(model, img_tensor, target_class=None):
    ...
    hook_handle = model.features.denseblock4.denselayer16.conv2.register_forward_hook(hook)
...
if best_model is not None:
    ...
    save_checkpoint(model, optimizer, epoch, 'apr24/densenet_untrained/checkpoint.pth.tar')
...
for image_path in image_paths:
    ...
    # predicted class index to the actual class label
    ...
    os.makedirs("apr24/densenet_untrained", exist_ok=True)

    output_image_path = f"apr24/densenet_untrained/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
