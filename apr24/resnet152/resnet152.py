...
output_file = 'apr24/resnet152/resnet152_trained_output.txt'
roc_curve_png = 'apr24/resnet152/ROC_curve_resnet152_trained.png'
roc_curve_txt = 'apr24/resnet152/ROC_data_resnet152_trained.csv'
confusion_matrix_png= 'apr24/resnet152/confusion_matrix_resnet152_trained.png'
...
if best_model is not None:
    ...
    save_checkpoint(model, optimizer, epoch, 'apr24/resnet152/checkpoint.pth.tar')
...
for image_path in image_paths:
    ...
    os.makedirs("apr24/resnet152", exist_ok=True)

    output_image_path = f"apr24/resnet152/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
