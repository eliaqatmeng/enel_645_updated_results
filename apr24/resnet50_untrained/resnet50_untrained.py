...
output_file = 'apr24/resnet50_untrained/resnet50_untrained_output.txt'
roc_curve_png = 'apr24/resnet50_untrained/ROC_curve_resnet50_untrained.png'
roc_curve_txt = 'apr24/resnet50_untrained/ROC_data_resnet50_untrained.csv'
confusion_matrix_png= 'apr24/resnet50_untrained/confusion_matrix_resnet50_untrained.png'
...
# Load untrained ResNet-50 model
...
if best_model is not None:
    ...
    save_checkpoint(model, optimizer, epoch, 'apr24/resnet50_untrained/checkpoint.pth.tar')
...
for image_path in image_paths:
    ...
    os.makedirs("apr24/resnet50_untrained", exist_ok=True)

    output_image_path = f"apr24/resnet50_untrained/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
