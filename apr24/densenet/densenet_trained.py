...
# Output file names
output_file = 'apr24/densenet/densenet_trained_output.txt'
roc_curve_png = 'apr24/densenet/ROC_curve_densenet_trained.png'
roc_curve_txt = 'apr24/densenet/ROC_data_densenet_trained.csv'
confusion_matrix_png= 'apr24/densenet/confusion_matrix_densenet_trained.png'
...
if best_model is not None:
    ...
    save_checkpoint(model, optimizer, epoch, 'apr24/densenet/checkpoint.pth.tar')
...
for image_path in image_paths:
    ...
    os.makedirs("apr24/densenet", exist_ok=True)

    output_image_path = f"apr24/densenet/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
