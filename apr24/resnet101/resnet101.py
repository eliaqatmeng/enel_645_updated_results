...
output_file = 'apr24/resnet101/resnet101_trained_output.txt'
roc_curve_png = 'apr24/resnet101/ROC_curve_resnet101_trained.png'
roc_curve_txt = 'apr24/resnet101/ROC_data_resnet101_trained.csv'
confusion_matrix_png= 'apr24/resnet101/confusion_matrix_resnet101_trained.png'
...
if best_model is not None:
    ...
    save_checkpoint(model, optimizer, epoch, 'apr24/resnet101/checkpoint.pth.tar')
...
for image_path in image_paths:
    ...
    os.makedirs("apr24/resnet101", exist_ok=True)

    output_image_path = f"apr24/resnet101/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
