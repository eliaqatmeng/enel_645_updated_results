...
output_file = 'apr24/resnet101_untrained/resnet101_untrained_output.txt'
roc_curve_png = 'apr24/resnet101_untrained/ROC_curve_resnet101_untrained.png'
roc_curve_txt = 'apr24/resnet101_untrained/ROC_data_resnet101_untrained.csv'
confusion_matrix_png= 'apr24/resnet101_untrained/confusion_matrix_resnet101_untrained.png'
...
# get a subset of dataset indices - In case it is taking too long to train in the cluster
...
def compute_grad_cam(model, img_tensor, target_class=None):
    ...
    hook_handle = model.layer4[-1].conv3.register_forward_hook(hook) 
...
if best_model is not None:
    ...
    save_checkpoint(model, optimizer, epoch, 'apr24/resnet101_untrained/checkpoint.pth.tar')
...
for image_path in image_paths:
    ...
    os.makedirs("apr24/resnet101_untrained", exist_ok=True)

    output_image_path = f"apr24/resnet101_untrained/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
