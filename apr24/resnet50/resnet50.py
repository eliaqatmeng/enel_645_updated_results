...
output_file = 'apr24/resnet50/resnet50_trained_output.txt'
roc_curve_png = 'apr24/resnet50/ROC_curve_resnet50_trained.png'
roc_curve_txt = 'apr24/resnet50/ROC_data_resnet50_trained.csv'
confusion_matrix_png= 'apr24/resnet50/confusion_matrix_resnet50_trained.png'
...
if best_model is not None:
    ...
    save_checkpoint(model, optimizer, epoch, 'apr24/resnet50/checkpoint.pth.tar')
...
for image_path in image_paths:
    ...
    os.makedirs("apr24/resnet50", exist_ok=True)

    output_image_path = f"apr24/resnet50/{os.path.basename(image_path).split('.')[0]}_gradcam_output.png"
